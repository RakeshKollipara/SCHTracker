<%@ Page Title="All Txns Search" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="Main" %>
        ...
        <div class="form-group">
            <table>
                ...
                <tr>
                    <td>
                        <div class="SearchTd2">
                            <asp:Label ID="Label4" runat="server" CssClass="sdm-required control-label" Text="Transaction Type" />
                            <asp:DropDownList ID="drdTxnType" runat="server" AutoPostBack="true" CssClass="form-control dropdown sdm-dropdown" OnSelectedIndexChanged="drdTxnType_SelectedIndexChanged" OnPreRender="drdTxnType_PreRender" />
                        </div>
                    </td>
                    <td>
                        <div class="SearchTd2">
                ...
                <tr>
                    <td colspan="5">
                        <asp:RequiredFieldValidator ID="reqDateto" ControlToValidate="txtDateTo" runat="server" CssClass="errorLabel" ErrorMessage="Please select DateTo" /><br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="drdTxnType" runat="server" CssClass="errorLabel" ErrorMessage="Please select Txn Type" /><br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtDateFrom" CssClass="errorLabel" runat="server" ErrorMessage="Please select DateFrom" /><br />
                    </td>
                </tr>
                                ...
                                <td>
                                    <asp:GridView ID="gvPurchaseOrder" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="IsICOE" HeaderText="ICOE Partner" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="IsICOE" />
                                            <asp:TemplateField HeaderText="Corp Status" SortExpression="POCorpStatus">
                                                <ItemStyle HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateField HeaderText="Extranet Status" SortExpression="Status">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="LoadID" HeaderText="Load ID" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                            <asp:TemplateField HeaderText="997/824 Sent" SortExpression="FunctionalAck">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="MDN of 997/824" SortExpression="MDNForFuncAck">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                            ...
                                            <%--<asp:BoundField DataField="isICOEPartner" HeaderText="BOM Received" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="isICOEPartner" />
                                            <asp:BoundField DataField="isICOEPartner" HeaderText="3B3 Received" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="isICOEPartner" />
                                            ...
                                            <asp:TemplateField HeaderText="" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCorpnetStatus" runat="server" Text='<%# Bind("POCorpStatus")%>' />
                                                    <asp:Label ID="lblExtStatus" runat="server" Text='<%# Bind("Status") %>' />
                                                    ...
                                                    <asp:Label ID="LabelFunctionalAck" runat="server" Text='<%# Bind("FunctionalAck") %>' />
                                                    <asp:Label ID="lblMDNForFuncAck" runat="server" Text='<%# Bind("MDNForFuncAck") %>' />
                                                    <asp:Label ID="lblPoNumber" runat="server" Text='<%# Bind("PONumber") %>' />
                                                    <asp:Label ID="lblICOE" runat="server" Text='<%# Bind("IsICOE") %>' />
                                                    <asp:Label ID="LabelLoadID" runat="server" Text='<%# Bind("LoadID") %>' />
                                                    <asp:Label ID="lblNoFuncAck" runat="server" Text='<%# Bind("NoFuncAck") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
