<%@ Page Title="ShowShipment 945 EDI/DESADV Search" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ShowShipment.aspx.cs" Inherits="ShowShipment" %>
    ...
    <div class="jumbotron">
        ...
        <script>
            ...
            function ShowNewPage() {
                ...
                modalWin.ShowURL('AchiveFilesPOPUp.aspx?type=SS', 420, 470, 'Archvie Files', null);
            }
        ...
        <div class="form-group">
            <table>
                <tr>
                    <td>
                        <div class="SearchTd1">
                            <asp:Label ID="Label3" runat="server" Text="Transaction ID" />
                ...
                <tr>
                    ...
                    <td>
                        <div class="SearchTd2">
                            <asp:Label ID="Label10" runat="server" Text="Message Type" />
                            <asp:DropDownList ID="drdTxnType" runat="server" AutoPostBack="true" CssClass="form-control dropdown sdm-dropdown">
                                <asp:ListItem Text="" Value="" />
                                <asp:ListItem Text="EDI" Value="945EDI" />
                                <asp:ListItem Text="DESADV" Value="945DESADV" />
                            </asp:DropDownList>
                        </div>
                    </td>
                                ...
                                <td>
                                    <asp:GridView ID="gvDO" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="LoadID" HeaderText="Purchase Order" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="LoadID" />
                                            ...
                                            <asp:TemplateField HeaderText="997" SortExpression="Ack997Status">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="824" SortExpression="Ack824Status">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Image ID="img824tatus" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Aperak" SortExpression="AckAperakStatus">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Image ID="imgAperakStatus" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="MDN" SortExpression="MDNStatus">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="" Visible="false">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblTxnType" runat="server" Text='<%# Bind("TxnType") %>' />/>
                                                    <asp:Label ID="lbl997FuncAck" runat="server" Text='<%# Bind("Ack997Status") %>' />
                                                    <asp:Label ID="lbl824FuncAck" runat="server" Text='<%# Bind("Ack824Status") %>' />
                                                    <asp:Label ID="lblAperakFuncAck" runat="server" Text='<%# Bind("AckAperakStatus") %>' />
                                                    <asp:Label ID="lblMDNStatus" runat="server" Text='<%# Bind("MDNStatus") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
